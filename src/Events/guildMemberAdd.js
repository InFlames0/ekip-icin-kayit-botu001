...
const {konfeti,red,green,star} = require("../Settings/emojidb.json")
...
kayitchannel.wsend(`
${star} Merhabalar ${member}  aramızda hoş geldin. Seninle beraber sunucumuz **${üyesayısı}** üye sayısına ulaştı. 
...
`);
channel.wsend(`
${green} ${member} sunucumuza katıldı Davet Eden: <@${invite.inviter.id}> Toplam Davet Sayısı: **${total}** 
`)
...
Seni Davet Eden : <@${invite.inviter.id}>. ${total} davet ${konfeti}${konfeti}${konfeti} `);
